...
namespace Mz.Storage.SpaceEngineers
{
    internal sealed class LocalStorageBackend : IStorageBackend
    {
        ...
        public LocalStorageBackend(Type callingType)
        {
        ...
        public bool Exists(string fileName)
        {
            ...
            return MyAPIGateway.Utilities.FileExistsInLocalStorage(fileName, _callingType);
        }

        public string Read(string fileName)
        {
            EnsureUtilitiesAvailable();
            using (var reader = MyAPIGateway.Utilities.ReadFileInLocalStorage(fileName, _callingType))
        ...
        {
            EnsureUtilitiesAvailable();
            using (var writer = MyAPIGateway.Utilities.WriteFileInLocalStorage(fileName, _callingType))
