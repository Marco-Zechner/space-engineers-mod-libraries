...
namespace Mz.Toml.Tests
{
    public sealed class TomlTableDiagnosticTests
    {
        ...
        [InlineData("[a]\nb = 1\n[a.b]\nc = 2\n")]
        [InlineData("a = 1\n[a.b.c.d]\n")]
        public void Scalar_Cannot_Be_Traversed_As_Table(
            string text)
        {
        ...
        [InlineData(
            ...
            "[a]\n" +
            "b.c.d.k.t = \"invalid\"\n")]
        public void Dotted_Key_Cannot_Append_Through_Explicit_Table(
            string text)
        {
            var result = Toml.TryParse(text);
        ...
        [InlineData("spelling = \"favorite\"\n'spelling' = \"favourite\"\n")]
        [InlineData("\"\\u0061\" = 1\na = 2\n")]
        public void Equivalent_Key_Definitions_Are_Duplicates(
            string text)
        {
            var result = Toml.TryParse(text);
        ...
        [InlineData("a..b = 1\n")]
        [InlineData("a. = 1\n")]
        public void Malformed_Dotted_Key_Is_Rejected(
            string text)
        {
            Assert.False(
        ...
        [InlineData("[a..b]\n")]
        [InlineData("[]\n")]
        public void Malformed_Table_Path_Is_Rejected(
            string text)
        {
            Assert.False(
                Toml.TryParse(text).IsSuccess);
